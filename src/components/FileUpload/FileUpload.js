    ...
    <>
      <div className={styles.outerBox}>
        <div className={`${styles.innerBox} col-11 col-sm-6 `}>
          ...
          <div className={`${styles.fileSelect} mx-sm-5 mx-3 pe-4`}><input className='col-10 col-sm-8 ' type="file" /></div>
          <div className={`${styles.innerBoxFooter} py-2`}><button className="btn btn-primary" type="button">Submit</button></div>
        </div>
      </div>
